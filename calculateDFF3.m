function dff = calculateDFF3(roiFluorescences, baseline_percentile)
...
%     
    for i=1:1:size(roiFluorescences,2)
        f0 = prctile(roiFluorescences(:,i), baseline_percentile);
        dff(:,i) = (roiFluorescences(:,i) - f0) / f0;
        
%         dff(:,i) = dff(:,i) - prctile(dff(:,i), 50);
