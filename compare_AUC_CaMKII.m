...
[frac_global_RITE,num_transients_RITE,global_AUC_RITE,ind_AUC_RITE,sum_events_RITE,tot_AUC_RITE,trace_AUC_RITE, num_ind_transients_RITE, num_global_transients_RITE] = group_graphs(CaMKII_RITE, norm_res);
[frac_global_IONCC,num_transients_IONCC,global_AUC_IONCC,ind_AUC_IONCC,sum_events_IONCC,tot_AUC_IONCC,trace_AUC_IONCC, num_ind_transients_IONCC, num_global_transients_IONCC] = group_graphs(CaMKII_Ion_CC, norm_res);
[frac_global_SHAM,num_transients_SHAM,global_AUC_SHAM,ind_AUC_SHAM,sum_events_SHAM,tot_AUC_SHAM,trace_AUC_SHAM, num_ind_transients_SHAM, num_global_transients_SHAM] = group_graphs(CaMKII_all_SHAM, norm_res);
...
y_vals = [reshape(trace_AUC_RITE.',1,[]), reshape(trace_AUC_IONCC.',1,[]), reshape(trace_AUC_SHAM.',1,[])];
groups{1} = repmat({'d0','d3','d7','d14','d21','d28'}, 1, size(trace_AUC_RITE,1) + size(trace_AUC_IONCC,1) + size(trace_AUC_SHAM,1));
groups{2} = [repmat({'RITE'}, 1, size(trace_AUC_RITE(:),1)), repmat({'IONCC'}, 1, size(trace_AUC_IONCC(:),1)), repmat({'SHAM'}, 1, size(trace_AUC_SHAM(:),1)) ] ;
...
%% ANOVA between RITE and SHAM

y_vals = [reshape(trace_AUC_RITE.',1,[]), reshape(trace_AUC_SHAM.',1,[])];
groups{1} = repmat({'d0','d3','d7','d14','d21','d28'}, 1, size(trace_AUC_RITE,1) +  size(trace_AUC_SHAM,1));
...
%%
figure;
errorbar(mean(global_AUC_RITE,1), std(global_AUC_RITE,1)/sqrt(5) ,'LineWidth',3, 'Color', 'r'); % , 'Marker', 's', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
hold on;
errorbar(mean(global_AUC_IONCC,1), std(global_AUC_IONCC,1)/sqrt(6) ,'LineWidth',3, 'Color', 'b'); % ,'Marker', '^', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
errorbar(mean(global_AUC_SHAM,1), std(global_AUC_SHAM,1)/sqrt(7) ,'LineWidth',3,'Color', '#008000'); % ,'Marker', 'o', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
% errorbar(mean([global_AUC_IONCC;global_AUC_SHAM],1), std([global_AUC_IONCC;global_AUC_SHAM],1)/sqrt(10) ,'LineWidth',3, 'Color', 'k');
hold off;
set(gca,'box','off','color','none', 'TickDir','out', 'fontsize',14);
ylabel('global AUC')
xticks([1,2,3,4,5,6]);
...
figure;
errorbar(mean(ind_AUC_RITE,1), std(ind_AUC_RITE,1)/sqrt(5) ,'LineWidth',3, 'Color', 'r'); % , 'Marker', 's', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
hold on;
errorbar(mean(ind_AUC_IONCC,1), std(ind_AUC_IONCC,1)/sqrt(6) ,'LineWidth',3, 'Color', 'b'); % ,'Marker', '^', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
errorbar(mean(ind_AUC_SHAM,1), std(ind_AUC_SHAM,1)/sqrt(7) ,'LineWidth',3,'Color', '#008000'); % ,'Marker', 'o', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
% errorbar(mean([ind_AUC_IONCC;ind_AUC_SHAM],1), std([ind_AUC_IONCC;ind_AUC_SHAM],1)/sqrt(10) ,'LineWidth',3, 'Color', 'k');
hold off;
set(gca,'box','off','color','none', 'TickDir','out', 'fontsize',14);
ylabel('ind AUC')
xticks([1,2,3,4,5,6]);
...
figure;
errorbar(mean(num_global_transients_RITE,1), std(num_global_transients_RITE,1)/sqrt(5) ,'LineWidth',3, 'Color', 'r'); % , 'Marker', 's', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
hold on;
errorbar(mean(num_global_transients_IONCC,1), std(num_global_transients_IONCC,1)/sqrt(6) ,'LineWidth',3, 'Color', 'b'); % ,'Marker', '^', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
errorbar(mean(num_global_transients_SHAM,1), std(num_global_transients_SHAM,1)/sqrt(7) ,'LineWidth',3,'Color', '#008000'); % ,'Marker', 'o', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
% errorbar(mean([num_global_transients_IONCC;num_global_transients_SHAM],1), std([num_global_transients_IONCC;num_global_transients_SHAM],1)/sqrt(10) ,'LineWidth',3, 'Color', 'k');
hold off;
set(gca,'box','off','color','none', 'TickDir','out', 'fontsize',14);
ylabel('# transients global')
xticks([1,2,3,4,5,6]);
xticklabels({'Day 0','Day 3','Day 7','Day 14','Day 21','Day 28'});
xtickangle(45);
legend('RITE','ION-CC','SHAM');

y_vals = [reshape(num_global_transients_RITE.',1,[]), reshape(num_global_transients_IONCC.',1,[]), reshape(num_global_transients_SHAM.',1,[])];
groups{1} = repmat({'d0','d3','d7','d14','d21','d28'}, 1, size(num_global_transients_RITE,1) + size(num_global_transients_IONCC,1) + size(num_global_transients_SHAM,1));
groups{2} = [repmat({'RITE'}, 1, size(num_global_transients_RITE(:),1)), repmat({'IONCC'}, 1, size(num_global_transients_IONCC(:),1)), repmat({'SHAM'}, 1, size(num_global_transients_SHAM(:),1)) ] ;
...
figure;
errorbar(mean(num_ind_transients_RITE,1), std(num_ind_transients_RITE,1)/sqrt(5) ,'LineWidth',3, 'Color', 'r'); % , 'Marker', 's', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
hold on;
errorbar(mean(num_ind_transients_IONCC,1), std(num_ind_transients_IONCC,1)/sqrt(6) ,'LineWidth',3, 'Color', 'b'); % ,'Marker', '^', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
errorbar(mean(num_ind_transients_SHAM,1), std(num_ind_transients_SHAM,1)/sqrt(7) ,'LineWidth',3,'Color', '#008000'); % ,'Marker', 'o', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
% errorbar(mean([num_ind_transients_IONCC;num_ind_transients_SHAM],1), std([num_ind_transients_IONCC;num_ind_transients_SHAM],1)/sqrt(10) ,'LineWidth',3, 'Color', 'k');
hold off;
set(gca,'box','off','color','none', 'TickDir','out', 'fontsize',14);
ylabel('# transients ind')
xticks([1,2,3,4,5,6]);
xticklabels({'Day 0','Day 3','Day 7','Day 14','Day 21','Day 28'});
xtickangle(45);
legend('RITE','ION-CC','SHAM');

y_vals = [reshape(num_ind_transients_RITE.',1,[]), reshape(num_ind_transients_IONCC.',1,[]), reshape(num_ind_transients_SHAM.',1,[])];
groups{1} = repmat({'d0','d3','d7','d14','d21','d28'}, 1, size(num_ind_transients_RITE,1) + size(num_ind_transients_IONCC,1) + size(num_ind_transients_SHAM,1));
groups{2} = [repmat({'RITE'}, 1, size(num_ind_transients_RITE(:),1)), repmat({'IONCC'}, 1, size(num_ind_transients_IONCC(:),1)), repmat({'SHAM'}, 1, size(num_ind_transients_SHAM(:),1)) ] ;
...
%% AUC analysis for all animals and groups across days
...
function [frac_global,num_transients,global_AUC,ind_AUC,sum_events,tot_AUC,trace_AUC, num_ind_transients, num_global_transients] = group_graphs(file_list, norm_res)
    ...
    num_ind_transients = zeros(length(file_list),6);
    num_global_transients = zeros(length(file_list),6);
    
    for i=1:length(file_list)
        disp(file_list(i));
        [frac_global(i,:),num_transients(i,:),global_AUC(i,:),ind_AUC(i,:),sum_events(i,:),tot_AUC(i,:),trace_AUC(i,:), global_AUC_all, ind_AUC_all, num_transients_neurons, frac_global_neurons, num_frames(i,:), num_ind_transients(i,:), num_global_transients(i,:)] = plot_CORR(file_list{i}, sprintf('Dlx Com-TN %d',i));
        for j=1:6
...
function [frac_global,num_transients,global_AUC,ind_AUC,sum_events, tot_AUC, trace_AUC, global_AUC_neurons, ind_AUC_neurons, num_transients_neurons, frac_global_neurons, num_frames, num_ind_transients, num_global_transients] = plot_CORR(plot_files, plot_title)
