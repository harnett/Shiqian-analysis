...
figure;
ax = subplot(1,1,1);
plot(mean(frac_global_RITE,1),'LineWidth',4, 'Color', '#752075', 'MarkerSize', 10, 'Marker', 'o', 'MarkerFaceColor', '#752075', 'MarkerEdgeColor', 'none'); %, 'Marker', 's', 'MarkerSize', 12, 'MarkerFaceColor', 'w'
hold on;
plot(mean(frac_global_IONCC,1),'LineWidth',4, 'Color', '#FF0000', 'MarkerSize', 10, 'Marker', 'o', 'MarkerFaceColor', '#FF0000', 'MarkerEdgeColor', 'none');
