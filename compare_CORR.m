...
stat_stop = [1,-1];  
%% just make plots    
plot_CORR(CaMKII_RITE, 'RITE', [4], {[1,3300], [1,3300], [2000,5300], [1300,4600], [1,3300], [2000,5300]});
...
[mean_corr_RITE, mean_dist_ne_RITE, mean_dist_e_RITE] = plot_CORR(CaMKII_RITE, 'RITE', [1,2,3,4,5], stat_stop);
...
mean_corr_RITE = plot_CORR(CaMKII_RITE, 'RITE', [1,2,3,4,5], stat_stop);
mean_corr_IONCC = plot_CORR(CaMKII_Ion_CC, 'IONCC', [1,2,3,4,5,6], stat_stop);
mean_corr_SHAM = plot_CORR(CaMKII_all_SHAM, 'SHAM', [1,2,3,4,5,6,7] ,stat_stop);
...
function [mean_corr, mean_dist_nonevent_all, mean_dist_event_all] = plot_CORR(plot_files, prefix, process_files, start_stop)
    plot_figs = true;
...
%         if plot_figs
%              print(gcf,strcat('/Users/lukasfischer/Work/exps/Shiqian/manuscript/v4/panels/Fig 2/',prefix,'_',num2str(i),fname,'.png'),'-dpng','-r600');
%          end\
        if plot_figs
