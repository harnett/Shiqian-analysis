...
carb = {{'/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 1/Carb 30 mg/Carb before/T_rigid';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 1/Carb 30 mg/Carb 30 min/T';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 1/Carb 60 mg/Carb 30 min/T'};...
        {'/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 2/Carb baseline/Tcarba baseline';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 2/Carb 30 mg/T60min_rigid';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 2/Carb 60 mg/T60min'};...
        {'/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 3/Carb baseline/T';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 3/Carb 30 mg/T';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 3/Carb 60 mg/T'};...
        {'/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 4/Carb baseline/T';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 4/Carb 30 mg/T';...
         '/Users/lukasfischer/Work/exps/Shiqian/Carbamazepine/Mouse 4/Carb 60 mg/T_rigid'}};
...
xticks([1,2,3]);
xticklabels({'Baseline','Carb. 30 mg','Carb 60 mg.'});
xtickangle(45);
xlim([0.8,3.2]);
ylim([0, 0.5]);
...
p_c60_PRE_POST = bootstrap_mean_diff(mean_corr(:,1), mean_corr(:,3), num_shuffles);

bonferroni_alpha = 0.05 / 2;

[~,p_carb60] = ttest(mean_corr(:,1), mean_corr(:,3))
mean(mean_corr(:,1))
std(mean_corr(:,1))/sqrt(4)
    
mean(mean_corr(:,3))
std(mean_corr(:,3))/sqrt(4)
    ...
    for i=1:length(plot_files)
        ...
        for j=1:length(plot_files{i})
            ...
            if plot_figs
                ...
                imagesc(ax, sess_data{i}{j}.dff_filtered_temp(1:3300,:)', [0.0, 0.8]); %max(max(sess_data{i}{j}.dff_filtered_temp))
                box off;
