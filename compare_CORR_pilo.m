...
pilo = {{'/Users/lukasfischer/Work/exps/Shiqian/Pilocarpine/Trial 1/Before Pilocarpine/T1';...
         '/Users/lukasfischer/Work/exps/Shiqian/Pilocarpine/Trial 1/After Pilocarpine/T1'};...
        {'/Users/lukasfischer/Work/exps/Shiqian/Pilocarpine/Trial 2/Before Pilocarpine/T2';...
         '/Users/lukasfischer/Work/exps/Shiqian/Pilocarpine/Trial 2/After Pilocarpine/T2'};...
        {'/Users/lukasfischer/Work/exps/Shiqian/Pilocarpine/Trial 3/Before Pilocarpine/T3_rigid';...
         '/Users/lukasfischer/Work/exps/Shiqian/Pilocarpine/Trial 3/After Pilocarpine/T3'}};

%% some parameters for the plots
stat_stop = [1,-1];
    
%% just make plots    
plot_CORR(pilo, 'PILOCARBINE', [1,2,3], [1,1000]);

%% run correlation analysis
              
mean_corr_PILO = plot_CORR(pilo, 'PILOCARBINE', [1,2,3], [1,1000]);


figure;
plot(mean_corr_PILO', 'linewidth', 3, 'Color', '#C9C9C9', 'Marker', 'o', 'MarkerSize', 8, 'MarkerFaceColor', 'w');
hold on;
errorbar(mean(mean_corr_PILO,1), std(mean_corr_PILO,1)/sqrt(3) ,'LineWidth',4, 'Color', 'k', 'Marker', 's', 'MarkerSize', 12, 'MarkerFaceColor', 'w');
hold off;
...
xticks([1,2]);
xticklabels({'Basline','Pilocarbine'});
...
p_d1_PILP = bootstrap_mean_diff(mean_corr_PILO(:,1), mean_corr_PILO(:,2), num_shuffles);
...
[~,p] = ttest(mean_corr_PILO(:,1), mean_corr_PILO(:,2))


%%


function mean_corr = plot_CORR(plot_files, prefix, process_files, start_stop)
    plot_figs = true;
    ...
    for k=1:length(process_files)
        ...
        for j=1:length(plot_files{i})
            ...
            if plot_figs
                ...
                ax = subplot(3,7,j);   % plot heatmap and set labels
%                 cm = gray;
%                 cm = flipud(cm);
%                 colormap(cm);
%                 colormap hot;
                ...
                pbaspect([2 1 1]);
                ax = subplot(3,7,7+j);   % plot heatmap and set labels
