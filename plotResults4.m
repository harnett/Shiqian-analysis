function plotResults4(varargin)
...
%             roi_centers = sortrows(roi_centers);
            ...
            for i=1:size(GUIHandles.dff,2)
                ...
                baseline_dff = GUIHandles.dff_filtered(:,i);
                ...
                GUIHandles.dff(:,i) = GUIHandles.dff(:,i) - baseline_correction';
                GUIHandles.dff_filtered(:,i) = GUIHandles.dff_filtered(:,i) - baseline_correction';
...
%         for i=1:size(GUIHandles.roi_transients,2)
% %             if i == 3
% %                 disp('stop');
% %             end
%             baseline_dff = GUIHandles.dff_filtered(:,i);
...
%         end
        ...
        bin_edges = linspace(0,max(1,transient_max),10);
        if size(roi_transients_individual,1) > 0
