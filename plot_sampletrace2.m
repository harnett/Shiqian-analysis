...
%% CaMKII RITE day 7 
datafile = "/Users/lukasfischer/Work/exps/Shiqian/final dataset/CaMKII/RITE/Mouse 4/day 7/T7.sig"; % File path to the data
% plot_rois = [11,14,18,35];   ,13
plot_rois = [14,42,33,35];
...
%% CaMKII SHAM day 3 M1
datafile = "/Users/lukasfischer/Work/exps/Shiqian/final dataset/CaMKII/SHAM/Sham(Com-TN)/Mouse 1/day 3/T3.sig"; % File path to the data
plot_rois = [2,4,1,12];   
frame_range = [1,3300];
plot_title = 'SHAM day 0';
...
%% DREADD CONTROL AFTER
datafile = "/Users/lukasfischer/Work/exps/Shiqian/DREADD/Control/After CNO/Mouse 1/2.sig"; % File path to the data
plot_rois = [12,17,46];   
frame_range = [1,3300];
plot_title = 'DREADD CONTROL AFTER';

plot_sampletraces(datafile, plot_rois, frame_range, plot_title)

%% DREADD Gi BEFORE
datafile = "/Users/lukasfischer/Work/exps/Shiqian/DREADD/Gi/Before/Mouse 1/7.sig"; % File path to the data
plot_rois = [17,19,21];   
frame_range = [1,3300];
plot_title = 'DREADD Gi BEFORE';

plot_sampletraces(datafile, plot_rois, frame_range, plot_title)

%% DREADD CONTROL BEFORE 2
datafile = "/Users/lukasfischer/Work/exps/Shiqian/DREADD/Control/Before CNO/Mouse 3/5.sig"; % File path to the data
plot_rois = [13,29,43,47];   
frame_range = [1,3300];
plot_title = 'DREADD CONTROL AFTER';

plot_sampletraces(datafile, plot_rois, frame_range, plot_title)

%% DREADD CONTROL AFTER 2
datafile = "/Users/lukasfischer/Work/exps/Shiqian/DREADD/Control/After CNO/Mouse 3/6.sig"; % File path to the data
plot_rois = [12,29,43,47];   
frame_range = [1,3300];
plot_title = 'DREADD CONTROL AFTER';
...
%% DREADD Gi AFTER
datafile = "/Users/lukasfischer/Work/exps/Shiqian/DREADD/Gi/After/Mouse 1/8.sig"; % File path to the data
plot_rois = [1,2,3];   
frame_range = [1,3300];
plot_title = 'DREADD Gi BEFORE';
